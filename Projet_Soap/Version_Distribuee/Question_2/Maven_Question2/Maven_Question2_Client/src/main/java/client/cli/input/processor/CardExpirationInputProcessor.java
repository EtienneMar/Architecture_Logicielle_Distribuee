...
public class CardExpirationInputProcessor extends ComplexeUserInputProcessor<String> {
	/*Attribut*/
	...
	public CardExpirationInputProcessor(Scanner inputReader, String message) {
