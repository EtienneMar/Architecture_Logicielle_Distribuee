...
public class Server {
	...
	public static void main(String[] args) throws IOException {
		...
		Endpoint.publish("http://localhost:8888/HotelWebService1Consultation", new WebService1ConsultationImpl(hotelsToBind.get(0)));
		Endpoint.publish("http://localhost:8888/HotelWebService2Reservation", new WebService2ReservationImpl(hotelsToBind.get(0)));
