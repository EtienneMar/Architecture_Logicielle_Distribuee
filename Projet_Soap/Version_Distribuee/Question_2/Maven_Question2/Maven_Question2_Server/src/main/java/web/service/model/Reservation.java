...
public class Reservation {
	...
	public LocalDate getDateArrivee() {return dateArrive;}
...
//			String tomorrowStr =  tomorrow.format(DateToString);
			System.out.println("Merci de saisir une date au format jj-mm-yyyy, à partir du TS " + dateToStringRes(tomorrow));
		}
	}
	...
	public String toString() {
		...
		str += String.format("date d'arrivé : %s, date départ : %s]"
				, dateToStringRes(this.getDateArrivee()), dateToStringRes(this.getDateDepart()));
		return str;
	}
